...
def evaluate_retrieval_results(
    ...
    for question_id, context_scores in tqdm(retrieval_data.items(), desc="Processing questions"):
        ...
        # Use the top-1 context (or combine top-k if needed)
        # For now, we use only top-1 as specified
        ...
        result = {
            ...
            "context_title": context_data.get("title", ""),
    ...
    output = {
        ...
        "experiment_description": "Evaluate top-1 retrieved contexts using Mistral API",
        "model": {
            "name": model_name,
            "type": "Mistral API"
        },
...
if __name__ == "__main__":
    ...
    parser.add_argument("--output_path", type=str, default="retrieval_evaluation_results.json",
    ...
    parser.add_argument("--top_k", type=int, default=1,
                        help="Number of top contexts to use (default: 1)")
